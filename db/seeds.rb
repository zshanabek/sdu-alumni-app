...
fields = ['Маркетинг', 'Информационные технологии', 'Бухгалтерский учёт', 'Администрация', 
          ...
          'Розничная торговля','Недвижимость', 'Продажи', 'Электроника, приборостроение, бытовая техника, компьютеры и оргтехника','Автомобильный бизнес',
           'Энергетика','Телекоммуникации, связь','Услуги для населения','Услуги для бизнеса','Страхование','Товары народного потребления',
